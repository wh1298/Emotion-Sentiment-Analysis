...
def main():
	...
	if choice == "Home":
		...
		# 	# Clean columns to avoid Unicode issues
		# 	for col in ['Rawtext', 'Prediction', 'Time_of_Visit']:
		# 		df_emotions[col] = df_emotions[col].astype(str).apply(
		...
		**Emotion Classifier App**  
		...
		- Supports emotion predictions with confidence scores.  
